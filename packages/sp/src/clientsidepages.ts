...
export class ClientSidePage extends SharePointQueryable {
     ...
     * @param promotedState PromotedState of the page to use
     */
    public static async create(web: Web | List, pageName: string, title: string,  pageLayoutType: ClientSidePageLayoutType = "Article", promotedState: PromotedState = 0): Promise<ClientSidePage> {
     ...
     * @param promotedState PromotedState of the new page
     * @param publish If true the page will be published
     */
    public async copyPage(web: Web | List, pageName: string, title: string, promotedState: PromotedState = 0, publish = true): Promise<ClientSidePage> {
